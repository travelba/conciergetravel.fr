...
Produire **deux descriptions étendues** (FR + EN) **800-1400 caractères** chacune. Cibler 1000-1200 chars (sweet spot SEO + lisibilité mobile).
...
1. **Longueur** : 800-1400 caractères pour CHAQUE locale. **Compte les caractères AVANT de répondre.**
...
7. **Phrases ≤ 25 mots** (règle voix Concierge — ADR-0011). Si une phrase dépasse, coupe.
...
1. ☐ `fr.length` ∈ [800, 1400] — compte les caractères
2. ☐ `en.length` ∈ [800, 1400] — compte les caractères
...
7. ☐ Phrases ≤ 25 mots dans les deux locales
