...
| **Audit the WHOLE site exhaustively** (8000+ URLs from the sitemap: 200 / single h1 / canonical / hreflang / no scaffolding leak / valid JSON-LD no Offer / live links + images / anti "0 hôtels") — L3 health crawler, prod or Vercel preview            | [`site-audit-crawler`](site-audit-crawler/SKILL.md) ⭐ NEW                                                                                                        |
