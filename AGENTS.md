...
| **Hotel kit rollout** (template 9 sections, consignes PO PdG → catalogue : F&B, GMB, POI photos, ton concierge, re-source photo)  | [`hotel-kit-rollout`](.cursor/skills/hotel-kit-rollout/SKILL.md) + [runbook](docs/runbooks/airelles-reference-fiche-plan.md) + rule [`hotel-kit-rollout.mdc`](.cursor/rules/hotel-kit-rollout.mdc) |
