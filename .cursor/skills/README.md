...
| **Keyword/SERP/intent grounding** (DataForSEO → FAQ + titres + GEO/AEO ancrés sur la demande réelle ; PAA select, cluster cache, per-item crash-resilience)                                                                                               | [`keyword-grounding-dataforseo`](keyword-grounding-dataforseo/SKILL.md) ⭐ NEW                                                                       |
