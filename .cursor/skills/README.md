...
| **Hotel kit rollout** (pilotes Airelles/PdG → catalogue — F&B, GMB, POI photos, ton concierge, photo officielle, **gates `kit.*` D15–D19**) | [`hotel-kit-rollout`](hotel-kit-rollout/SKILL.md) · `kit-fiche-acceptance-gates.ts`                                                                  |
