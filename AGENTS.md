...
| **Audit the WHOLE site at scale** (every published URL works/clicks/coherent — 200, h1, canonical, hreflang, no scaffolding leak, valid JSON-LD, live links + images, anti "0 hôtels") | [`site-audit-crawler`](.cursor/skills/site-audit-crawler/SKILL.md) + `scripts/site-audit` (`pnpm --filter @mch/site-audit crawl`)                                                                                                    |
